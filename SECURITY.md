...
The Black team and community take all security vulnerabilities in Black seriously.

Thank you for improving the security of Black. We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
**[admin@black.one](mailto:admin@black.one)**.  *Please avoid opening a public issue on the repository for critical security issues.*

The Black team will send a response indicating the next steps in handling your
...
If you believe that an existing (public) issue is a critical-security-related issue, please email **[admin@black.one](mailto:admin@black.one)**. The email should include the issue ID and
...
|         | Telegram       | Discord                         |
| ------  | -------------  | ------------------------------  |
| Puneet  | `@mkoijn6`     | `Puneet | Black 💪#0507`  |
| Anmol   | `@anmol1696`   | `anmol1696 | Black#0348`  |
| Sanjeev | `@ping_echo`   | `Echo | AUDIT.one#7553`         |
| Ajaz    | `@ajansari95`  | `Ajaz Ahmed | Black#0296` |
| Arham   | `@arhamchordia`| `Arham | Black#4526`      |
...
- Demonstrate good faith by not disrupting or degrading Black's services.
...
This process can take some time. Every effort will be made to handle the bug in as timely a manner as possible. However, it's important that we follow the process described above to ensure that disclosures are handled consistently and to keep Black and the projects running on it secure.